...
/**
 * Login page — fully self-contained and ready to paste.
 * It honors location.state.from (coming from ProtectedRoute) and redirects back.
 */
export default function Login() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      // redirect handled by useEffect after auth/role resolves
    } catch (error) {
    ...
    <div className="main-content">
      <form className="auth-form" onSubmit={handleSubmit}>
        ...
        <div className="socials">
          ...
          <button className="social-btn" type="button">
            <img src="/images/apple.svg" alt="" width="18" /> Continue with Apple
          </button>
        </div>
